...
//post the data for sign to login page
...
// Server-side code
//res-booking and pagination code for get route
...
app.post('/search', async (req, res) => {
 ...
 //<-------------------------| voice views page where the print options |---------------------->
...
// <------------------------------------------------Done events-------------------------------->
 //===================get the data form booked events
app.get('/done', (req, res) => {
  Done.find().then(data => {
    res.render('done', { data: data })
  }).catch(err => { console.log(err) })
});
//==========================post the fetched data on new page 
...
//<-----------------------------------------------Edit done if he required-------------------->
app.put('/done/edit/:id', (req, res) => {
  Done.findOne({
    _id:req.params.id
  }).then(data => {
    data.slip = req.body.slip,
...
app.get('/done/edit/:id', (req, res) => {
  Done.findOne({
    _id: req.params.id
  }).then(data => {
    res.render('editdone', { data: data })
  }).catch(err => console.log(err))
})
//<=------------------------------| Del the Done events  |-------------------------------------->
